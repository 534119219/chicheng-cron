...
.dshc-trigger{box-sizing:border-box;display:flex;align-items:center;justify-content:center;gap:6px;height:38px;
  ...
  background:var(--dsw-alias-bg-layer-2,#1f2430);color:var(--dsw-alias-label-primary,#e6e9ef);
  border-radius:12px;font-size:14px;font-weight:500;line-height:22px;cursor:pointer;overflow:hidden;white-space:nowrap;
  width:calc(100% - 4px)}
.dshc-trigger:hover{background:var(--dsw-alias-interactive-bg-hover,#262c3a)}
...
.dshc-dot[data-on="true"]{background:var(--dsw-alias-state-success-primary,#3ddc84)}
.dshc-dot[data-on="false"]{background:var(--dsw-alias-label-tertiary,#6b7280)}
...
.dshc-badge{display:inline-flex;align-items:center;padding:1px 7px;border-radius:99px;font-size:11px;line-height:16px;
  background:var(--dsw-alias-bg-layer-2,#1b202b);color:var(--dsw-alias-label-secondary,#9aa3b2)}
.dshc-badge[data-kind="ok"]{background:color-mix(in srgb,var(--dsw-alias-state-success-primary,#3ddc84) 16%,transparent);color:var(--dsw-alias-state-success-primary,#3ddc84)}
.dshc-badge[data-kind="failed"]{background:color-mix(in srgb,var(--dsw-alias-state-error-primary,#f45d5d) 16%,transparent);color:var(--dsw-alias-state-error-primary,#f45d5d)}
.dshc-badge[data-kind="running"]{background:color-mix(in srgb,var(--dsw-alias-state-business-primary,#639efe) 18%,transparent);color:var(--dsw-alias-state-business-primary,#639efe)}
.dshc-badge[data-kind="timeout"]{background:color-mix(in srgb,var(--dsw-alias-state-warn-primary,#f59e0b) 16%,transparent);color:var(--dsw-alias-state-warn-primary,#f59e0b)}
.dshc-badge[data-kind="off"]{background:color-mix(in srgb,var(--dsw-alias-state-warn-primary,#f59e0b) 16%,transparent);color:var(--dsw-alias-state-warn-primary,#f59e0b)}
...
.dshc-section{border:1px solid var(--dsw-alias-border-l2,#3a3f4b);border-radius:12px;padding:14px;margin-bottom:14px;background:var(--dsw-alias-bg-layer-3,#1b202b)}
...
.dshc-input,.dshc-select,.dshc-textarea{box-sizing:border-box;width:100%;padding:7px 10px;font-size:13px;color:inherit;
  background:var(--dsw-alias-bg-layer-1,#10141d);border:1px solid var(--dsw-alias-border-l2,#3a3f4b);border-radius:9px;
  outline:none;font-family:inherit}
.dshc-input:focus,.dshc-select:focus,.dshc-textarea:focus{border-color:var(--dsw-alias-button-primary-fill,#3964fe)}
...
.dshc-preset{border:1px solid var(--dsw-alias-border-l2,#3a3f4b);background:var(--dsw-alias-bg-layer-2,#1b202b);
  color:var(--dsw-alias-label-secondary,#9aa3b2);font-size:11px;padding:2px 8px;border-radius:99px;cursor:pointer}
.dshc-preset:hover{border-color:var(--dsw-alias-button-primary-fill,#3964fe);color:var(--dsw-alias-label-primary,#e6e9ef)}
.dshc-preview{margin-top:6px;font-size:12px;color:var(--dsw-alias-label-secondary,#9aa3b2)}
.dshc-preview[data-error="true"]{color:var(--dsw-alias-state-error-primary,#f45d5d)}
...
.dshc-push-ph-chip{border:1px solid var(--dsw-alias-border-l2,#3a3f4b);background:var(--dsw-alias-bg-layer-2,#1b202b);
  color:var(--dsw-alias-label-secondary,#9aa3b2);font-size:11px;padding:2px 10px;border-radius:99px;cursor:pointer}
.dshc-push-ph-chip:hover{border-color:var(--dsw-alias-button-primary-fill,#3964fe);color:var(--dsw-alias-label-primary,#e6e9ef)}
.dshc-check{display:flex;align-items:center;gap:8px;cursor:pointer;user-select:none}
.dshc-check input{accent-color:var(--dsw-alias-button-primary-fill,#3964fe)}
...
.dshc-btn{display:inline-flex;align-items:center;gap:6px;padding:7px 14px;border-radius:10px;border:1px solid var(--dsw-alias-border-l2,#3a3f4b);
  background:var(--dsw-alias-bg-layer-2,#1f2430);color:var(--dsw-alias-label-primary,#e6e9ef);font-size:13px;cursor:pointer}
.dshc-btn:hover{background:var(--dsw-alias-interactive-bg-hover,#262c3a)}
.dshc-btn[data-primary="true"]{background:var(--dsw-alias-button-primary-fill,#3964fe);border-color:var(--dsw-alias-button-primary-fill,#3964fe);color:var(--dsw-alias-label-primary-inverted,#fff)}
.dshc-btn[data-primary="true"]:hover{background:var(--dsw-alias-button-primary-hover,#2f56e8)}
.dshc-btn[data-danger="true"]{color:var(--dsw-alias-state-error-primary,#f45d5d)}
.dshc-btn[data-toggle="off"]{color:var(--dsw-alias-state-warn-primary,#f59e0b)}
.dshc-btn[data-toggle="on"]{color:var(--dsw-alias-state-success-primary,#3ddc84)}
.dshc-btn:disabled{opacity:.5;cursor:default}
.dshc-spacer{flex:1}
.dshc-error{color:var(--dsw-alias-state-error-primary,#f45d5d);font-size:12px;margin-top:8px}
...
.dshc-run-out{border:1px solid var(--dsw-alias-border-l1,#262b36);background:var(--dsw-alias-bg-layer-1,#10141d);border-radius:8px;padding:8px 10px;
