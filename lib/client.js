...
.dshc-trigger[data-collapsed="true"]:hover{background:var(--dsw-alias-button-floating-hover,#2a3140)}
...
.dshc-input,.dshc-select,.dshc-textarea{box-sizing:border-box;width:100%;padding:7px 10px;font-size:13px;color:inherit;
  background:var(--dsw-alias-bg-layer-2,#10141d);border:1px solid var(--dsw-alias-border-l2,#3a3f4b);border-radius:9px;
...
.dshc-btn{display:inline-flex;align-items:center;gap:6px;padding:7px 14px;border-radius:10px;border:1px solid var(--dsw-alias-border-l2,#3a3f4b);
  background:var(--dsw-alias-button-floating-fill,#1d2230);color:inherit;font-size:13px;cursor:pointer}
...
.dshc-run-out{border:1px solid var(--dsw-alias-border-l1,#262b36);background:var(--dsw-alias-bg-layer-2,#10141d);border-radius:8px;padding:8px 10px;
